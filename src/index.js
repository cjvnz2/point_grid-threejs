...
const uniforms = {
  ...
  u_spd_modifier_1: { value: 0.06 },
  // wave 2
  u_noise_freq_2: { value: 3 },
  u_noise_amp_2: { value: 0.09 },
  u_spd_modifier_2: { value: 0.7 }
};
...
let camera = createCamera(30, 1, 100, { x: 0, y: 0, z: 4.5 });
...
let app = {
  ...
  async initScene() {
    ...
    if (false) {
      ...
      wave2
        .add(uniforms.u_noise_amp_2, "value", 0.01, 3, 0.01)
        .name("Amplitude")
        .onChange((val) => {
